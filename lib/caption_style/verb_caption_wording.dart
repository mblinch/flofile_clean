...
class VerbCaptionWording {
  ...
  static String defaultPluralWording(String verb, String singularPhrase) {
    const byVerb = <String, String>{
      ...
      'Rounds': 'round a base',
      'Looks On': 'look on',
      'Walks Off Field': 'walk off the field',
      'Runs Off Field': 'run off the field',
      'Takes the Field': 'take the field',
      'Comes Off the Field': 'come off the field',
      'Takes the Ice': 'take the ice',
      'Comes Off the Ice': 'come off the ice',
      'Takes the Court': 'take the court',
      'Comes Off the Court': 'come off the court',
      'Skates': 'skate',
      'Shoots': 'shoot',
      'Battles': 'battle',
      'Scores': 'score',
